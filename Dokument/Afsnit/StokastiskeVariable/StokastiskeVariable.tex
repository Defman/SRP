...
Et sandsynlighedsfelt findes på to former, vi vil kun beskæftige os med det endelige sandsynlighedsfelt. Det endelig sandsynlighedsfelt $(U, P)$ er bestående af et udfaldsrum $U$ og en sandsynlighedsfunktion $P$. Hvis der er tale om et symmetrisk sandsynlighedsfelt, vil følgende være gældende for $P$.
\begin{align}
  P(U) &= 1 \\
  P(U_1) + P(U_i) + ... + P(U_n) &= 1
\end{align}
